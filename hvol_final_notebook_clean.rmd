...
```{r}
'''
data = read_csv("multi_h_volcanii_compare_table_gdtools.csv") %>%
...
write_csv(data, "h_volcanii_mutations.csv")
rm(data)
...
write_csv(data, "h_volcanii_mutations_raw_observations.csv")
'''
...
data = read_csv("h_volcanii_mutations.csv") %>%
...
all_mutations = read_csv("h_volcanii_mutations.csv") %>%
